...
class RadioSearcher
{
    ...
    public function __construct(private readonly RadioStationRepository $repository)
    {
        $this->catalogue = [
            ...
            ['name' => 'BBC 6 Music',  'streamUrl' => 'https://as-hls-ww.live.cf.md.bbci.co.uk/pool_904/live/ww/bbc_6music/bbc_6music.isml/bbc_6music-audio%3d96000.norewind.m3u8', 'genre' => 'Alternative'],
            ['name' => 'BBC Radio 1',  'streamUrl' => 'https://as-hls-ww.live.cf.md.bbci.co.uk/pool_904/live/ww/bbc_radio_one/bbc_radio_one.isml/bbc_radio_one-audio%3d96000.norewind.m3u8', 'genre' => 'Pop'],
            ['name' => 'BBC Radio 2',  'streamUrl' => 'https://as-hls-ww.live.cf.md.bbci.co.uk/pool_904/live/ww/bbc_radio_two/bbc_radio_two.isml/bbc_radio_two-audio%3d96000.norewind.m3u8', 'genre' => 'Easy Listening'],
        ];
    }
